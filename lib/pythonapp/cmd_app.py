...
class AsyncThreadingManager(threading.Thread):
    ...
    def __init__(self, config_dict: dict,  config_save_path, logger: logging.Logger) -> None:
        super().__init__()
        self.daemon = True
    ...
    def _run(self):
        ...
        self.loop.run_until_complete(asyncio.ensure_future(self.downloader.start_following_download()))
...
def main():
    ...
    parser.add_argument('--configfile', nargs='?', default='jsons/default_config.json',required=True)
    ...
    while True:
        ...
        # 数据库操作
            ...
            data = asyncbackupcollection.find(
